...
def trainer_synapse(args, model, snapshot_path, tf_log_dir, device):
    ...
    writer = SummaryWriter(tf_log_dir + '/log')
    iter_num = 0
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = 0.4 * loss_ce + 0.6 * loss_dice # 37
        ...
        if ((epoch_num + 1) % args.eval_interval == 0)  and (epoch_num + 1) > 50 :
